                  ...
                  >
                    <div className="flex items-center justify-between">
                      <div className="flex items-center gap-4">
                        ...
                        <div>
                          <div className="text-sm text-gray-600">Номер заказа</div>
                      ...
                      <div className="flex items-center gap-4">
                        <div className="text-right">
                          <div className="text-sm text-gray-600">Дата заказа</div>
                        ...
                        <div className="flex items-center gap-2">
                          <span className={clsx('px-3 py-1 rounded-full text-sm font-medium flex items-center gap-1', statusInfo.className)}>
                            {statusInfo.icon}
                            {statusInfo.text}
                          </span>
                        </div>
                        ...
                        <svg
                          className={clsx('w-5 h-5 text-gray-400 transition-transform duration-300', {
        ...
        {myOrders?.length === 0 && (
          <div className="text-center space-y-6 py-12">
            ...
            <div className="space-y-2">
              <h3 className="text-xl font-semibold text-gray-800">Нет заказов</h3>
